...
if __name__ == '__main__':
    ...
    active_bene2 = pd.read_csv(config.PATH_WD_IMP + 'data sources\\72860461.csv', dtype='object', encoding='cp1251')
    active_bene = pd.concat([active_bene, active_bene2])
    ...
    active_benec.loc[active_benec['Event Date'] < '24-JUL-2023', 'Event Date'] = '24-JUL-2023'
    ...
    active_benec.drop_duplicates(inplace=True)
    ...
    hce_data.to_csv(r'C:\Users\akaff\OneDrive - KBP Investments\Workday Implentation\Data Conversion\data files\health_care_elections_WD.csv')

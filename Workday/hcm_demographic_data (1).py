...
if __name__ == '__main__':
    ...
    active_ees['Employee Id'] = active_ees['Employee Id'].astype(int)
    active_ees = active_ees.sort_values('Employee Id')
    active_ees = active_ees.groupby("Employee Id").first()
    active_ees.reset_index(inplace=True)
    ...
    active_ees['Hispanic or Latino'] = np.where(active_ees['Ethnicity'] == 'Hispanic or Latino', 'Y', 'N')
    ...
    active_ees['Ethnicity #1'] = np.where(active_ees['Ethnicity']== 'White (not Hispanic or Latino)', 'White_United_States_of_America',
                  ...
                  np.where(active_ees['Ethnicity']== 'Hispanic or Latino', '', 'Not_Specified')))))))
    ...
    demo_data_c1 = demo_data_c.drop(['Source System','Marital Status','Ethnicity #1', 'Hispanic or Latino'],axis=1)

    df_d = active_ees[['Worker ID','Source System','Marital Status','Ethnicity #1', 'Hispanic or Latino']]
